...
import {Box, Grid, makeStyles, Tab, Table, TableBody, TableCell, TableRow, Typography} from '@material-ui/core';
             ...
             <Grid item lg={7} md={7} sm={8} xs={12} className={classes.rightContainer}>
                ...
                <Typography className={clsx(classes.smallText,classes.grayText)}>
                 ...
                 <Typography>
                     ...
                     <span className={classes.grayText}><strike>₹{product.price.mrp}</strike></span> &nbsp; &nbsp; &nbsp;
